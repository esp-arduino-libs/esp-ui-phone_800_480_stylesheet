...
/* Home */
#define ESP_UI_PHONE_800_480_DARK_HOME_DATA()                                     \
    {                                                                             \
        .status_bar = {                                                           \
            .data = ESP_UI_PHONE_800_480_DARK_STATUS_BAR_DATA(),                  \
        ...
        .recents_screen = {                                                       \
            .data = ESP_UI_PHONE_800_480_DARK_RECENTS_SCREEN_DATA(),              \
...
/* Phone */
#define ESP_UI_PHONE_800_480_DARK_STYLESHEET()               \
    {                                                        \
        .core = ESP_UI_PHONE_800_480_DARK_CORE_DATA(),       \
        .home = ESP_UI_PHONE_800_480_DARK_HOME_DATA(),       \
        .manager = ESP_UI_PHONE_800_480_DARK_MANAGER_DATA(), \
    }
