...
LV_IMG_DECLARE(esp_ui_phone_800_480_wallpaper_image_drak);

/* Home */
#define ESP_UI_PHONE_800_480_DARK_CORE_HOME_DATA()                                                      \
    {                                                                                                   \
        .background = {                                                                                 \
            .color = ESP_UI_STYLE_COLOR(0x1A1A1A),                                                      \
            .wallpaper_image_resource = ESP_UI_STYLE_IMAGE(&esp_ui_phone_800_480_wallpaper_image_drak), \
        },                                                                                              \
        .text = {                                                                                       \
        ...
        .container = {                                                                                  \
            .styles = {                                                                                 \
                ...
                { .outline_width = 3, .outline_color = ESP_UI_STYLE_COLOR(0xf7b731), },                 \
                { .outline_width = 2, .outline_color = ESP_UI_STYLE_COLOR(0x20bf6b), },                 \
                { .outline_width = 1, .outline_color = ESP_UI_STYLE_COLOR(0x0fb9b1), },                 \
                { .outline_width = 3, .outline_color = ESP_UI_STYLE_COLOR(0x2d98da), },                 \
            },                                                                                          \
        },                                                                                              \
    }

/* manager */
#define ESP_UI_PHONE_800_480_DARK_CORE_MANAGER_DATA() \
    {                                                 \
        .app = {                                      \
            .max_running_num = 3,                     \
        },                                            \
...
/* Core */
#define ESP_UI_PHONE_800_480_DARK_CORE_INFO_DATA_NAME    "EUI-Phone Dark"
#define ESP_UI_PHONE_800_480_DARK_CORE_DATA()                     \
    {                                                             \
        .name = ESP_UI_PHONE_800_480_DARK_CORE_INFO_DATA_NAME,    \
        .screen_size = ESP_UI_STYLE_SIZE_RECT(800, 480),          \
        .home = ESP_UI_PHONE_800_480_DARK_CORE_HOME_DATA(),       \
        .manager = ESP_UI_PHONE_800_480_DARK_CORE_MANAGER_DATA(), \
    }
