...
#define ESP_UI_PHONE_800_480_DARK_APP_LAUNCHER_ICON_DATA() \
    {                                                      \
        .main = {                                          \
            .size = ESP_UI_STYLE_SIZE_SQUARE(164),         \
            .layout_row_pad = 10,                          \
        },                                                 \
        .image = {                                         \
...
#define ESP_UI_PHONE_800_480_DARK_APP_LAUNCHER_DATA()                       \
    {                                                                       \
        .main = {                                                           \
            .y_start = 0,                                                   \
        ...
        .table = {                                                          \
            .default_num = 3,                                               \
            .size = ESP_UI_STYLE_SIZE_RECT_W_PERCENT(100, 346),             \
        },                                                                  \
        .indicator = {                                                      \
        ...
        .icon = ESP_UI_PHONE_800_480_DARK_APP_LAUNCHER_ICON_DATA(),         \
        .flags = {                                                          \
