...
/* Area */
#define ESP_UI_PHONE_800_480_DARK_STATUS_BAR_AREA_DATA(w_percent, align) \
    {                                                                    \
...
/* Status Bar */
#define ESP_UI_PHONE_800_480_DARK_STATUS_BAR_DATA()                                                       \
    {                                                                                                     \
        .main = {                                                                                         \
        ...
        .area = {                                                                                         \
            ...
            .data = {                                                                                     \
                ESP_UI_PHONE_800_480_DARK_STATUS_BAR_AREA_DATA(33, ESP_UI_STATUS_BAR_AREA_ALIGN_START),   \
                ESP_UI_PHONE_800_480_DARK_STATUS_BAR_AREA_DATA(34, ESP_UI_STATUS_BAR_AREA_ALIGN_CENTER),  \
                ESP_UI_PHONE_800_480_DARK_STATUS_BAR_AREA_DATA(33, ESP_UI_STATUS_BAR_AREA_ALIGN_END),     \
            },                                                                                            \
        },                                                                                                \
