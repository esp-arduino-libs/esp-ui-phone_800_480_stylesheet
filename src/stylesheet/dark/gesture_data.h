...
#define ESP_UI_PHONE_800_480_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA() \
    {                                                                     \
        .main = {                                                         \
...
#define ESP_UI_PHONE_800_480_DRAK_GESTURE_BOTTOM_INDICATOR_BAR_DATA() \
    {                                                                 \
        .main = {                                                     \
...
#define ESP_UI_PHONE_800_480_DARK_GESTURE_DATA()                                   \
    {                                                                              \
        .detect_period_ms = 20,                                                    \
        .threshold = {                                                             \
        ...
        .indicator_bars = {                                                        \
            [ESP_UI_GESTURE_INDICATOR_BAR_TYPE_LEFT] =                             \
                ESP_UI_PHONE_800_480_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA(), \
            [ESP_UI_GESTURE_INDICATOR_BAR_TYPE_RIGHT] =                            \
                ESP_UI_PHONE_800_480_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA(), \
            [ESP_UI_GESTURE_INDICATOR_BAR_TYPE_BOTTOM] =                           \
                ESP_UI_PHONE_800_480_DRAK_GESTURE_BOTTOM_INDICATOR_BAR_DATA(),     \
        },                                                                         \
        .flags = {                                                                 \
